...
<body>
    <header>
        ...
        <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-mail">
            ...
            <path d="M3 7l9 6l9 -6" />
        </svg>guadalupe@fundacionloyola.es</p>
    </header>
    <nav>
    ...
    <main>
        <div class="tabla">
            <div class="container">
                ...
                <form action="mostrarEliminarLibros.php" method="POST">
                    
                    <input type="text" name="isbn" placeholder="Ingrese el ISBN del libro a eliminar" >              

                    <input class="boton mt-2" type="submit" value="Eliminar">
